...
import loading_dots from '../../assets/img/loading.gif'
    ...
    return(
        <nav className='w-full py-4 top-0 fixed'>
            ...
            <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap md:px-12 px-2">
                ...
                <NavLink to='/carreras' className="text-lg inline-flex font-medium leading-6 text-gray-900 border-b-2 border-white hover:border-orange-500 mx-4">Carreas</NavLink>
